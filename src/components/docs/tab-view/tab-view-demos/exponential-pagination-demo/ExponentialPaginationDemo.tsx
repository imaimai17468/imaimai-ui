...
export function ExponentialPaginationDemo({
	...
	return (
		<div className="space-y-8">
			...
			<DemoSection
				title="最初のページ"
				description="現在ページの前後3ページは連続で表示され、その外側は累積的に2の累乗でジャンプします。モバイルではPrev/Nextボタンが上部に配置されます。"
			>
				<DemoCard centered>
			...
			<DemoSection
				title="中間ページ"
				description="現在ページの前後3ページは連続で表示され、その外側は累積的に2の累乗でジャンプします。"
			>
				<DemoCard centered>
					<ExponentialPagination
			...
			<DemoSection
				title="最終ページ付近"
				description="最終ページ付近では、前方の連続ページと累積的な2の累乗のページが表示されます。"
			>
				<DemoCard centered>
					<ExponentialPagination
